 ...
 */
async function sendSlackAlert(message, color = '#ff0000') {
 ...
 */
function canSendAlert(instanceId) {
 ...
 */
async function sendAlert(instanceId, instanceName, alertType, message) {
