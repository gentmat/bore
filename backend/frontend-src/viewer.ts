...
const iframe = document.getElementById('tunnelFrame') as HTMLIFrameElement;
...
(window as any).reloadTunnel = reloadTunnel;
(window as any).openInNewWindow = openInNewWindow;
