...
const ErrorResponses = {
  ...
  unauthorized: (
    ...
    requestId: string | null = null,
  ): Response => sendError(res, 401, "unauthorized", message, null, requestId),
  ...
  invalidToken: (res: Response, requestId: string | null = null): Response =>
    sendError(
      res,
      401,
      "invalid_token",
  ...
  forbidden: (
    ...
    requestId: string | null = null,
  ): Response => sendError(res, 403, "forbidden", message, null, requestId),
  ...
  conflict: (
    ...
    requestId: string | null = null,
  ): Response => sendError(res, 409, "conflict", message, null, requestId),
  ...
  databaseError: (res: Response, requestId: string | null = null): Response =>
    sendError(
      res,
      500,
      "database_error",
